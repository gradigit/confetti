...
struct HeightMap {
    ...
    /// Calibrated for ~55% screen height in 5 minutes at 5 landings/sec:
    /// ~1450 landings, cosine splat across ~50 columns (effective area ~32),
    /// each column receives ~130 overlapping contributions → peak ≈ 4.0pt
